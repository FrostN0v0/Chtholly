...
from ..native_image_delivery import send_pending_native_images, discard_pending_native_images
...
async def finish_turn(
    ...
    For delivered, native images accompanying this response are sent through the current turn's verified delivery
    boundary before success is returned. Generated bytes alone never count as confirmed output.
